...
<body>
	<main>
		...
		<div class="contenido">
			<form class="formulario" action="/ttm/usuario/editarUsuario.do"
				method="post">
				...
				<button type="submit" class="btn btn-success mt-3 mx-3" href="/ttm/usuario/editarUsuario.do">Confirmar</button>
				<a href="/ttm/usuario/listaUsuarios.do"
